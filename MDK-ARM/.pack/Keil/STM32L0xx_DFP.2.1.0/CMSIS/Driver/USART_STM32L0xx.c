...
/*! \page stm32l0_usart CMSIS-Driver USART Setup in Synchronous mode
...
----------
  ...
  2. Configure pins PA8 .. PA10 as USART1 peripheral alternative pins
     - Click in chip diagram on pin \b PA8  and select \b USART1_CK
...
#include "USART_STM32L0xx.h"

#ifndef HAL_USART_MODULE_ENABLED
  #warning "::Device:STM32Cube Framework: USART Not configured."
#else
...
USARTx_RESOURCE_ALLOC(4);
#endif

// USART5
#ifdef USART5_MODE_SYNC
USARTx_RESOURCE_ALLOC(5);
#endif
...
#endif
#ifdef USART4_MODE_SYNC
  if (husart->Instance == USART4) { usart = &USART4_Resources; }
#endif
#ifdef USART5_MODE_SYNC
  if (husart->Instance == USART5) { usart = &USART5_Resources; }
#endif
...
#ifdef USART4_MODE_SYNC
USARTx_EXPORT_DRIVER(4);
#endif

#ifdef USART5_MODE_SYNC
USARTx_EXPORT_DRIVER(5);
#endif
