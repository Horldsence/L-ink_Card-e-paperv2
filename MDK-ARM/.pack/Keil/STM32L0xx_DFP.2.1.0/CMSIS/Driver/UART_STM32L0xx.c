 ...
 * $Revision:    V1.1
 *
 * Driver:       Driver_USART1, Driver_USART2, Driver_USART4, Driver_USART5
 *
...
/* History:
 *  Version 1.1
 *    Updated CMSIS USART Driver: Corrected UARTx/USARTx related typing mistakes
 *  Version 1.0
 *    Initial release
 */

/*! \page stm32l0_uart CMSIS-Driver USART Setup in Asynchronous mode
...
----------
  1. Configure peripheral
     - Peripherals \b USART2: Mode=<b>Asynchronous</b>, Hardware Flow Control=<b>Disable</b>

  2. Configure pins PD5 and PD6 as USART2 peripheral alternative pins
     - Click in chip diagram on pin \b PD5 and select \b USART2_TX
     - Click in chip diagram on pin \b PD6 and select \b USART2_RX
...
-----------------
  1. Under Connectivity open \b USART2 Configuration:
     ...
     - <b>GPIO Settings</b>: review settings, no changes required
          ...
          :--------|:--------------|:-------------|:------------|:-------------------|:------------|:------------|:----------
          PD5      | USART2_TX     | n/a          | Alternate ..| Pull-up            | Very High   | n/a         |.
          PD6      | USART2_RX     | n/a          | Alternate ..| Pull-up            | Very High   | n/a         |.
...
#endif
#ifdef USART4_MODE_ASYNC
  if (usart == USART4)  { __HAL_RCC_USART4_RELEASE_RESET(); }
#endif
#ifdef USART5_MODE_ASYNC
  if (usart == USART5)  { __HAL_RCC_USART5_RELEASE_RESET(); }
#endif
}
