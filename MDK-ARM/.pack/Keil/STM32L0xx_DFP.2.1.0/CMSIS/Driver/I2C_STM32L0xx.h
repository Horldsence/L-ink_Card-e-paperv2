 ...
 * $Revision:    V1.0
 *
 * Project:      I2C Driver definitions for STMicroelectronics STM32L0xx
 * -------------------------------------------------------------------------- */

#ifndef __I2C_STM32L0XX_H
#define __I2C_STM32L0XX_H
...
typedef struct {
  ...
  uint32_t              periph_clk;           // Peripheral clock (RCC_PERIPHCLK_I2C1/2/3)
