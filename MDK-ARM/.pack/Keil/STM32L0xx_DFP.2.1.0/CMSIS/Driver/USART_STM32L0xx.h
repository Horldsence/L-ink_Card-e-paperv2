 ...
 * $Revision:    V1.0
 *
 * Project:      USART Driver definitions for STMicroelectronics STM32L0xx
 * -------------------------------------------------------------------------- */

#ifndef __USART_STM32L0XX_H
#define __USART_STM32L0XX_H
...
#ifdef MX_USART4
#if   (MX_USART4_VM == VM_SYNC)

// USART4 used in Synchronous mode
#define USART4_MODE_SYNC                1

// USART4 DMA USE
#ifdef MX_USART4_TX_DMA_Instance
  #define USART4_DMA_USE_TX             USART_DMA_USE_TX
#else
  #define USART4_DMA_USE_TX             0
#endif
#ifdef MX_USART4_RX_DMA_Instance
  #define USART4_DMA_USE_RX             USART_DMA_USE_RX
#else
  #define USART4_DMA_USE_RX             0
#endif
#define USART4_DMA_USE                  (USART4_DMA_USE_TX | USART4_DMA_USE_RX)
#endif
#endif

// USART5 Configuration
#ifdef MX_USART5
#if   (MX_USART5_VM == VM_SYNC)

// USART5 used in Synchronous mode
#define USART5_MODE_SYNC                1

// USART5 DMA USE
#ifdef MX_USART5_TX_DMA_Instance
  #define USART5_DMA_USE_TX             USART_DMA_USE_TX
#else
  #define USART5_DMA_USE_TX             0
#endif
#ifdef MX_USART5_RX_DMA_Instance
  #define USART5_DMA_USE_RX             USART_DMA_USE_RX
#else
  #define USART5_DMA_USE_RX             0
#endif
#define USART5_DMA_USE                  (USART5_DMA_USE_TX | USART5_DMA_USE_RX)
#endif
#endif

#if defined(USART1_MODE_SYNC) ||        \
    defined(USART2_MODE_SYNC) ||        \
    defined(USART4_MODE_SYNC) ||        \
    defined(USART5_MODE_SYNC)
...
#ifdef USART4_MODE_SYNC
extern ARM_DRIVER_USART Driver_USART4;
#endif

#ifdef USART5_MODE_SYNC
